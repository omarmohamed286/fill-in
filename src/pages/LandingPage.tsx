...
const LandingPage = () => {
  ...
  if (!user && userStatus != "loading") {
    if (userStatus == "error") {
      return <p className="text-rose-400">Werid Error Happened!</p>;
    }
    return (
      <main className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="text-light-cyan/90 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed font-medium">
            ...
            future.
            <span className="text-white font-extrabold"> Fill In</span> helps
            you avoid future problems by identifying your knowledge gaps through
            a series of questions with explanations and external resources to
            help you learn what you don't know, ahead of time.
          </p>
